    ...
    public abstract class Loader : MonoBehaviour
    {
        ...
        protected IEnumerator Build(string absolutePath, string objName, Transform parentTransform)
        {
           ...
           ////newObj.transform.localScale = Vector3.one * Scaling;
            ...
            ImportModelManager.instance.importedModels[ObjectName(absolutePath)] = newObj;
            LoadMaterialTexture(basePath, "01_-_Default1noCulling.JPG");
        }
        string ObjectName(string absolutePath)
        {
            string[] str = absolutePath.Split("/");
