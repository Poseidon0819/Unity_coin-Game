...
namespace FrostweepGames.WebGLPUNVoice
{
    ...
    public class Speaker
    {
        ...
        public Speaker(int id, string name, Transform parent)
        {
            ...
            _selfObject.transform.localPosition = new Vector3(0, 2, 0);
        ...
        public void Update()
        {
            try
            {
                ...
                if(!Playing && !PlayerCharacter.Get().recorder.recording)
                {
        ...
        public void Dispose()
        {
            ...
            {
                UnityEngine.Object.Destroy(_workingClip);
            }
            UnityEngine.Object.Destroy(_selfObject);
            _selfObject = null;
        }
